...
Clarinet.test({
	...
	async fn(chain: Chain, accounts: Map<string, Account>) {
		...
		block.receipts[0].results.expectErr().expectUint(100);
	},
});
...
Clarinet.test({
	...
	async fn(chain: Chain, accounts: Map<string, Account>) {
		...
		block.receipts[1].results.expectErr().expectUint(101);
...
Clarinet.test({
	...
	async fn(chain: Chain, accounts: Map<string, Account>) {
		...
		block.receipts[0].results.expectErr().expectUint(102);
...
Clarinet.test({
	...
	async fn(chain: Chain, accounts: Map<string, Account>) {
		...
		block.receipts[0].results.expectErr().expectUint(105);
		assertEquals(block.receipts[0].events.length, 0);
	},
});
...
Clarinet.test({
	...
	async fn(chain: Chain, accounts: Map<string, Account>) {
		...
		block.receipts[0].results.expectErr().expectUint(104);
		assertEquals(block.receipts[0].events.length, 0);
	},
});
